async function entrenarModelo() {
    ...
    const net = new brain.NeuralNetwork({
        hiddenLayers: [64, 64], // Puedes ajustar esto según sea necesario
        activation: 'tanh' // Otras opciones: 'relu', 'sigmoid', 'tanh', etc.
    });
    ...
    const stats = net.train(trainingData, {
        ...
        logPeriod: 500, // Muestra el progreso cada 100 iteraciones
